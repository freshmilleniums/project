...
/* @var $tasksDocuments TasksDocuments[] */

$this->title = 'Task: '. $model->name;
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                                        ...
                                        <div class="col-6 col-sm-4 col-md-3 col-lg-2 mb-3">
                                            <div class="card shadow-sm" style="height: 100%; padding: 6px; border: 1px solid #ddd; border-radius: 8px;">
                                                <div class="card-body p-1 d-flex flex-column align-items-center justify-content-center text-center" style="min-height: 180px;">
                                                    <?php if ($label->isImage()): ?>
                                                        <a href="<?= $label->getUrl() ?>" target="_blank">
                                                            <img src="<?= $label->getUrl() ?>"
                                                                 class="img-thumbnail mb-2"
                                                                 style="max-width: 100%;   "
                                                                 alt="Label">
                                                        </a>
                                                    <?php elseif ($label->isPdf()): ?>
                                                        <i class="fas fa-file-pdf fa-2x text-danger mb-1"></i>
                                                        <div class="small text-truncate" style="max-width: 100%">
                                                            <?= Html::encode($label->getFileName()) ?>
                                                        </div>
                                                    <?php else: ?>
                        ...
                        <div class="mt-4">
                            <?php if ($model->status == Tasks::STATUS_IN_PROGRESS): ?>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="panel panel-default">
                                                    ...
                                                    <div class="panel-body documents_container-items">
                                                        <?php foreach ($tasksDocuments as $index => $taskDocument): ?>
                                                            <div class="documents_item card mb-3">
                                                                ...
                                                                <div class="card-body">
                                                                    <?php if (!$taskDocument->isNewRecord) {
                                                                        echo Html::activeHiddenInput($taskDocument, "[{$index}]id");
                                                                    } ?>

                                                                    <?php
                                                                    $initialPreview = [];
                                                                    if ($taskDocument->path) {
                                                                        $initialPreview[] = $taskDocument->getUrl();
                                                                    }

                                                                    echo $form->field($taskDocument, "[{$index}]file")->widget(FileInput::class, [
                                                                        'pluginOptions' => [
                                                                            'initialPreview' => $initialPreview,
                                                                            'initialCaption' => $taskDocument->getFileName(),
                                                                            'showUpload' => false,
                                                                            'initialPreviewFileType' => !empty(pathinfo($taskDocument->path)['extension']) ?
                                                                                (in_array(pathinfo($taskDocument->path)['extension'], ['pdf']) ? 'text' : 'image') : 'image',
                        ...
                        <!-- Action Buttons -->
                        <div class="mt-4">
                            <?php if ($model->status == Tasks::STATUS_NEW): ?>
                                <?= Html::a(
                                    '<i class="fas fa-play"></i> Task received',
                                    ['start-task', 'id' => $model->id],
                                    [
                                        'class' => 'btn btn-success',
                                        'data' => [
                                            'confirm' => 'Are you sure you want to receive this task?',
                                            'method' => 'post',
                                        ],
                                    ]
                                ) ?>
                        ...
                        <div class="mt-3">
                            <?= Html::a('<i class="fas fa-arrow-left"></i> Back to Tasks List', ['tasks'], ['class' => 'btn btn-secondary']) ?>
                        </div>
